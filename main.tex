...
\begin{figure}[!h]
\subfloat{\includegraphics[scale=0.2]{img/vgg16/AR_f.png}} 
\subfloat{\includegraphics[scale=0.2]{img/vgg16/AR_m.png}}\\
\subfloat{\includegraphics[scale=0.2]{img/vgg16/ES_f.png}}
\subfloat{\includegraphics[scale=0.2]{img/vgg16/ES_m.png}}\\ 
\subfloat{\includegraphics[scale=0.2]{img/vgg16/EN_f.png}}
\subfloat{\includegraphics[scale=0.2]{img/vgg16/EN_m.png}}
...
\begin{figure}[!h]
\subfloat{\includegraphics[scale=0.2]{img/resnet/AR_f.png}} 
\subfloat{\includegraphics[scale=0.2]{img/resnet/AR_m.png}}\\
\subfloat{\includegraphics[scale=0.2]{img/resnet/ES_f.png}}
\subfloat{\includegraphics[scale=0.2]{img/resnet/ES_m.png}}\\ 
\subfloat{\includegraphics[scale=0.2]{img/resnet/EN_f.png}}
\subfloat{\includegraphics[scale=0.2]{img/resnet/EN_m.png}}
